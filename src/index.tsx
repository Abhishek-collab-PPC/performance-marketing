            ...
            <div class="why-me-grid">
              ...
              <div class="why-item">
                ...
                <div>
                  ...
                  <span>I build infrastructure that scales, not just short-term wins</span>
                </div>
              </div>
              <div class="why-item">
                <div class="why-icon"><i class="fas fa-globe"></i></div>
                <div>
                  <strong>Global Market Experience</strong>
                  <span>US, UK, Canada, Australia, UAE &amp; Europe markets</span>
                </div>
              </div>
              <div class="why-item">
                ...
                <div>
                  ...
                  <span>Weekly reports, proactive communication, 24hr response</span>
                </div>
              </div>
            </div>
          </div>
